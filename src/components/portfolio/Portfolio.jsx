        ...
        <Box sx={{ width: '100%' }}>
          <TabContext value={value}>
                ...
                <h3>
                  ...
                  <h4>
                    <span className="expected">
                      Infosys Limited, India - Sept 2019 to Sept 2022 - Cloud
                      Solution Architect
                    </span>{' '}
                    <br />
                    ...
                    <br />• Innovated CloudFormation templates to provision EC2
                    instances, RDS, CloudWatch alarms, IAM users and roles using
                    parameters, mappings, resources, outputs <br />• Regulated
                    and maintained 20+ EC2 servers along with managing the user
                    provisioning, group provisioning, user ownership of 25 users
                    and changing file permissions on OS level on these servers{' '}
                    <br />• Managed the access of AWS services using IAM.
                    Restricting the users by providing the minimum access to AWS
                    services with the help of User groups
                  </h4>
                  <br />
                  <br />
                  <br />
              ...
              <div className="item">
                <h3>
                  ...
                  <h4>
                    ...
                    <a
                      target="_blank"
                      href="https://github.com/Anay-Pampatwar/Stocks-Portfolio-Manager-React-App"
                    >
                      <GitHubIcon />
                    </a>
                    <br />
                    ...
                    <a
                      target="_blank"
                      href="https://github.com/Anay-Pampatwar/cerealkillers/tree/master"
                    >
                      <GitHubIcon />
                    </a>
                  </h4>
            ...
            <TabPanel value="5">
              <div className="item">
                <h3>
                  ...
                  <h4>
                    Validation Number: GQJP516JBEV11QGF
                    <br /> View my certification here
                    <a
                      target="_blank"
                      href="https://www.linkedin.com/posts/anay-pampatwar28_aws-certificate-activity-6830679042228854784-sqgc?utm_source=share&utm_medium=member_desktop"
                    >
                      <LinkIcon />
                    </a>
                  </h4>
            ...
            <TabPanel value="6">
              <div className="item">
                <h3 >
                  <WorkspacePremiumIcon /> Skills I am proficient at:
                  <hr
                    style={{
                      color: 'aliceblue',
                      backgroundColor: 'aliceblue',
                  ...
                  <table>
                    <tr>
                      <th>•	Object Oriented Programming: <span font-weight="200">Java, Python, C#</span> </th>
                    </tr>
                    <tr>
                      <th>•	Database: <span font-weight="200">MySQL Server, Microsoft SQL Server</span> </th>
                    </tr>
                    <tr>
                      <th>•	Operating System Administration: <span font-weight="200">Linux, Shell Scripting</span> </th>
                    </tr>
                    <tr>
                      <th>•	Front-end technologies: <span font-weight="200">HTML, CSS, JavaScript</span> </th>
                    </tr>
                    <tr>
                      <th>•	Computer Networking: 		<span font-weight="200">TCP/IP Protocols, Servers and Routers communication</span> </th>
                    </tr>
                    	
                    <tr>
                      <th>•	Cloud Platform:  <span font-weight="200">AWS - EC2, S3, IAM, Load Balancers, CloudWatch</span> 
                      </th>
                    </tr>
                  </table>
